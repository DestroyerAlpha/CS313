...
//		System.out.println(Cycles);
		...
		int l = getEventQueue().getSize();
		for (int i = 0; i < l; i++) {
			Event event = getEventQueue().queue.remove();
			System.out.println(event.eventType);
//			if (getEventQueue().queue.poll().eventType == EventType.MemoryRead) {
//				MemoryReadEvent e = (MemoryReadEvent) getEventQueue().queue.element();
