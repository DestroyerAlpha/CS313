...
public class CacheLi implements Element{
	...
	public CacheLi(Processor CP, int lines) {
...
//	}
	...
	public void handleEvent(Event e) {
		...
		if (e.getEventType() == EventType.MemoryRead) {
			...
			System.out.println("Address Given to Cache: " + Address);
...
//			Simulator.getEventQueue().addEvent(new MemoryResponseEvent(Clock.getCurrentTime(), this, e.getRequestingElement(), getWord(event.getAddressToReadFrom())));
		...
		if (e.getEventType() == EventType.MemoryResponse) {
			...
			System.out.println("Returning Value: " + event.getValue());
